...
export const getCompanyFA = async (ticker: string): Promise<fa_num> => {
  ...
  const fa_num = {
    ...
    week52_low: $('body > div.content > div.ticker-wrapper.gradient-fade > div:nth-child(5) > table > tbody > tr > td > div > table:nth-child(1) > tbody > tr > td > div.screener_snapshot-table-wrapper > table > tbody > tr:nth-child(7) > td:nth-child(10) > b').contents().filter(function() { return this.nodeType === 3; }).text().trim(),
    week52_high: $('body > div.content > div.ticker-wrapper.gradient-fade > div:nth-child(5) > table > tbody > tr > td > div > table:nth-child(1) > tbody > tr > td > div.screener_snapshot-table-wrapper > table > tbody > tr:nth-child(6) > td:nth-child(10) > b').contents().filter(function() { return this.nodeType === 3; }).text().trim(),
  };
  return fa_num;
};
