    ...
    message.channel.send({
      embeds: [{
        ...
        fields: [
          ...
          { name: 'Market Cap', value: fa_num.mcap, inline: true },
		  ...
		  { name: '52-week Low', value: fa_num.week52_low, inline: true },
		  { name: '52-week High', value: fa_num.week52_high, inline: true },          
          { name: '\u200b', value: '\u200b', inline: true },
